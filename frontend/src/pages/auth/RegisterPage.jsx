import { HardHat, Leaf, ShoppingBasket, Truck, UserRound, UsersRound } from 'lucide-react';
      ...
      <div className="card w-full max-w-xl p-8">
        ...
        <form className="mt-6 grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
          ...
          <label className="block md:col-span-2">
            ...
            <input className="w-full rounded-xl border border-emerald-400/20 bg-slate-950/60 px-4 py-3" type="password" value={form.password} onChange={(event) => update('password', event.target.value)} minLength={6} required/>
          </label>
